...
export const SlideItem: FC<SlideItemProps> = ({ item, className, setOpenModal }) => {
    return (
        <div className={classNames(styles.slide__item, `${className}`)}>
            <div className={styles.slide__bg}>
                <img className={styles.slide__picture} src={item.pictureSrc} alt="hero__picture" />
            </div>
            <div className={styles.slide__content}>
                <svg
                    className={styles.slide__svg}
                    width="100%"
                    height="100%"
                    viewBox="0 0 613 440"
                    fill="none"
                ...
                <div className={styles.content__info}>
                    ...
                    <div className={styles.content__btns}>
                        <Button className={styles.content__btn} variant="primary" onClick={() => setOpenModal(true)}>
                            Записаться
                        </Button>
                        <Button className={styles.content__btn} variant="outline">
                            Подробнее
                        </Button>
                    </div>
                </div>
